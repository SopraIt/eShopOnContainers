...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AttributeList : IEquatable<AttributeList>
    { 
        /// <summary>
        /// Attribute code
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AttributeList)obj);
        }

        /// <summary>
        /// Returns true if AttributeList instances are equal
        /// </summary>
        /// <param name="other">Instance of AttributeList to be compared</param>
        /// <returns>Boolean</returns>

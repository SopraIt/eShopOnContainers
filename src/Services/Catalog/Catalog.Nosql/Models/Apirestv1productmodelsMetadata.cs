...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Apirestv1productmodelsMetadata : IEquatable<Apirestv1productmodelsMetadata>
    { 
        /// <summary>
        /// Status of the product model regarding the user permissions (only available since the v2.3 in the Enterprise Edition)
        /// </summary>
        /// <value>Status of the product model regarding the user permissions (only available since the v2.3 in the Enterprise Edition)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Apirestv1productmodelsMetadata {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Apirestv1productmodelsMetadata)obj);
        }

        /// <summary>
        /// Returns true if Apirestv1productmodelsMetadata instances are equal
        /// </summary>
        /// <param name="other">Instance of Apirestv1productmodelsMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Apirestv1productmodelsMetadata other)
        {
        ...
        public static bool operator ==(Apirestv1productmodelsMetadata left, Apirestv1productmodelsMetadata right)
        {
